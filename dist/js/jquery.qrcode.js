(function ($) {
  ...
  function drawBackgroundLabel(qr, context, settings) {
    ...
    var font = 'normal ' + settings.mSize * size + 'px ' + settings.fontname;
    ...
    context.fillText(settings.label, sl * size, st * size + 0.5 * settings.mSize * size);
  ...
  function drawBackgroundMode(qr, context, settings) {
  ...
  function drawBackground(qr, context, settings) {
    ...
    if(settings.mBlank === 0) {
      drawBackgroundMode(qr, context, settings);
    }
  }
